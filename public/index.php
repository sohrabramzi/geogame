...
// set a constant that holds the project's "view" folder, like "/var/www/application/view".
define('VIEW', APP . 'view' . DIRECTORY_SEPARATOR);
// set a constant that holds the project's "model" folder, like "/var/www/application/model".
